...
const MODEL_PATH = `${import.meta.env.BASE_URL}mars/25042_Perseverance.glb`
...
interface PerseveranceViewerProps {
  className?: string
}

export function PerseveranceViewer({ className = 'w-full h-[400px]' }: PerseveranceViewerProps) {
  return (
