...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    event: 'SÉPARATION BOOSTERS — T+3:39. P120C larguées à ~65 km. Étage central seul.',
    detail: 'Les deux boosters à propergol solide ont épuisé leur carburant et se détachent à 65 km. Leur rôle était d\'apporter la poussée supplémentaire nécessaire au décollage. L\'étage central (EPC) et son moteur Vulcain 2.1 continuent seuls.',
  ...
  },
  {
    ...
    event: 'ORBITE BASSE CONFIRMÉE — T+18:30. Vinci circularise à ~300 km. Vitesse orbitale atteinte.',
    detail: 'Le moteur Vinci (18 tf de poussée) amène l\'étage supérieur à la vitesse orbitale : environ 7 700 m/s (28 000 km/h). À cette vitesse, la trajectoire courbe de la fusée suit exactement la courbure de la Terre — elle est en orbite.',
  ...
  },
  {
    ...
    event: 'PHASE BALISTIQUE — Moteur éteint. L\'étage dérive librement en orbite elliptique pendant ~56 min.',
    detail: 'Vinci s\'est éteint. L\'étage continue sur son élan, en orbite elliptique. Les systèmes passent en veille pour gérer les extrêmes thermiques : -180 °C à l\'ombre, +120 °C face au Soleil.',
  ...
  {
    id: 'relight',
    label: 'Rallumage Vinci — Circularisation',
    shortLabel: 'Rallumage Vinci',
    tStart: 4495, tEnd: 4900,
    speedMultiplier: 20,
    color: 'text-sky-300', bgColor: 'bg-sky-500/15', borderColor: 'border-sky-500/40',
    event: 'RALLUMAGE VINCI — T+1h14:55. Manœuvre de circularisation vers l\'orbite finale.',
    detail: 'Deuxième allumage du moteur Vinci. Cette manœuvre d\'apogée circularise l\'orbite elliptique en une orbite ronde à l\'altitude cible. C\'est la dernière impulsion propulsive de la mission.',
  ...
  },
  {
    ...
    event: 'SÉPARATION CONFIRMÉE — T+1h29:55. Satellites en orbite opérationnelle. Signal télémétrie acquis.',
    detail: 'Les satellites se séparent de l\'adaptateur et déploient leurs panneaux solaires. Le centre de contrôle acquiert leur signal de télémétrie : la charge utile est en vie et autonome. Mission accomplie.',
    altitude: 520, velocity: 7600,
    critical: false,
