...
const SAT_LINES = [
  ...
  { speaker: 'boy' as const,  text: "Choisis l'orbite qui t'intéresse et découvre les défis d'ingénierie qui vont avec !" },
];
...
export function SatelliteSection({ onComplete, onHome, onBack }: SatelliteSectionProps) {
  ...
  const orbits = [
    ...
    },
    {
      ...
      period: 'Variable',
      engineering: 'En inclinant l\'orbite à ~98°, le satellite survole les pôles et passe au-dessus de chaque point de la Terre une fois par jour. L\'orbite héliosynchrone est calibrée pour que le satellite passe toujours à la même heure locale solaire — garantissant un éclairage constant d\'une image à l\'autre, essentiel pour comparer des photos prises à des mois d\'intervalle. Ces satellites d\'observation (Sentinel, SPOT) embarquent des caméras à 30 cm de résolution.',
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-cyan-950 to-slate-900 text-white py-16 px-6">
      ...
      <div className="max-w-4xl mx-auto mt-20">
        ...
        <Subsection
          ...
          content="Un satellite est en chute libre perpétuelle — mais il va si vite latéralement que la courbure de la Terre s'écarte aussi vite qu'il tombe. C'est l'équilibre entre la vitesse tangentielle et l'attraction gravitationnelle. Plus on est haut, plus on doit aller vite pour maintenir l'orbite... non, moins vite ! La gravité diminue et la période s'allonge. C'est la première loi de Kepler : à 400 km (LEO) il faut 7,7 km/s ; à 36 000 km (GEO) seulement 3,1 km/s, mais la distance est 90 fois plus grande."
          icon="🌐"
        />

        <Subsection
          title="Durée de Vie et Fin de Mission"
          content="Un satellite est conçu pour 10 à 15 ans. Le facteur limitant n'est généralement pas la panne des instruments, mais l'épuisement du carburant de contrôle d'attitude et de station-keeping. À l'issue de sa vie, il doit être mis sur une orbite cimetière (GEO) ou désorbité pour brûler dans l'atmosphère (LEO) : c'est une exigence réglementaire pour éviter la prolifération des débris spatiaux. Aujourd'hui, plus de 27 000 objets de plus de 10 cm sont suivis en orbite — un enjeu critique pour les prochaines décennies."
          icon="♻️"
        />

        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-8">
          <h3 className="text-2xl font-semibold mb-2">Choisissez une Orbite à Explorer</h3>
          <p className="text-gray-400 mb-6">Chaque altitude impose ses propres contraintes d'ingénierie. Sélectionnez-en une pour voir les défis techniques associés.</p>
